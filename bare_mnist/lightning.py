...
def main():
    cli = LightningCLI(model_class=LiftModel, datamodule_class=MnistDataModule, trainer_defaults=dict(max_epochs=14, gpus=int(torch.cuda.is_available())), save_config_overwrite=True)
