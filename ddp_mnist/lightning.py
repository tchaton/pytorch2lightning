...
def main():
    cli = LightningCLI(LiftModel, MnistDataModule, trainer_defaults=dict(max_epochs=14, gpus=torch.cuda.device_count(), accelerator="ddp"), save_config_overwrite=True, save_config_callback=None)
