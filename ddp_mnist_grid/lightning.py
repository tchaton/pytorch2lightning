...
def main():
    ...
    cli = LightningCLI(model_class=LiftModel, datamodule_class=MnistDataModule, trainer_defaults=dict(max_epochs=2, gpus=n_gpus, accelerator="ddp"), save_config_overwrite=True, save_config_callback=None)
